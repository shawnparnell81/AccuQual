...
/** Admin Console "System Health" (Phase 10) — cross-module diagnostics, admin-only (like every other cross-cutting company-admin surface: company.routes.ts's ai-config/ai-usage). */
