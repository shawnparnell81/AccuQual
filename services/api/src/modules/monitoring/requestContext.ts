 ...
 * helper — carries the same request id (and, once known, tenant and user)
...
/** Adds what became known mid-request (the authenticated user, the tenant). No-op outside a request. */
